// src/pages/Notificações/notificações.jsx
...
export default function Notificacoes() {
  ...
  const setarDeslocamento = (id, x) => {
    ...
    setNotificacoes((prev) => [...prev]); // força re-render
  };
  ...
  const aoMoverPonteiro = (e) => {
    ...
    const translateX = Math.min(0, dx); // só pra esquerda
              ...
              return (
                <li
                  ...
                  className={`w-full rounded-xl shadow-sm overflow-hidden transition-all duration-200 ${
                    !lida
                      ? "bg-[#FFF8F8] border border-[#E35151]/70 hover:shadow-md"
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex flex-col items-end gap-2 flex-shrink-0 ml-4">
                      ...
                      <button
                        onClick={() => removerNotificacaoLocalEBack(n.id)}
                        className="p-2 rounded-lg bg-white border border-gray-300 shadow-sm
                                   hover:bg-red-50 hover:border-red-300 focus:outline-none focus:ring-2 focus:ring-red-300"
                        aria-label="remover"
                        title="Remover"
                      >
