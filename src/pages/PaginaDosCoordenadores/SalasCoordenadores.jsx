    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-neutral-950">
      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 lg:px-10 -mt-10 md:-mt-12 flex flex-col items-center">
          <div className="w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden flex items-center justify-center">
            <img src={AvatarDefault} alt="Samira" className="w-full h-full object-contain" />
          </div>
          <p className="mt-2 font-semibold text-neutral-800 dark:text-neutral-100">Samira</p>
        </div>
        ...
        <div className="mt-6 w-full" style={{ backgroundColor: COR }}>
          <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 lg:px-10 py-8 md:py-12 text-center text-white">
            ...
            <p className="mt-3 text-sm md:text-base opacity-90">
              Visão estratégica, otimiza recursos e garante mais eficiente e personalizada.
            </p>
            <p className="text-sm md:text-base opacity-90">
              Organize com clareza, inspire resultados e faça a gestão acontecer.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full">
        <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 lg:px-10 py-8 md:py-10 relative">
          {/* Botão Editar sala — MOBILE (fluxo) */}
          <div className="md:hidden mb-5">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <path d="M3 17.25V21h3.75L18.81 8.94l-3.75-3.75L3 17.25z" stroke="currentColor" strokeWidth="1.8" />
                <path d="M14.06 5.19l3.75 3.75" stroke="currentColor" strokeWidth="1.8" />
              </svg>
              Editar sala
            </button>
          </div>

          {/* Botão Editar sala — DESKTOP (absoluto) */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            {[
              ...
              },
              {
                ...
                img: ImgImpressora3D,
                desc: "Controle os agendamentos de uso produtivo das impressoras 3D.",
                to: "/agendamento-auditorio",
              },
            ].map((c) => (
              <div key={c.titulo} className="w-full md:w-[500px] mx-auto">
                {/* Pílula vermelha com título */}
                <div
