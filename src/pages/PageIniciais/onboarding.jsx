...
function Onboarding() {
  ...
  // margem do parágrafo: 0/1 médio, 2 maior
  const paragraphMt =
    index === 2 ? "mt-16 md:mt-20 lg:mt-24"
    : (index === 0 || index === 1) ? "mt-12 md:mt-16 lg:mt-20"
    : "mt-6";
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 lg:gap-20 w-full">
            ...
            <div className={`w-full md:w-1/2 ${textAlign}`}>
              ...
              <p className={`${paragraphMt} text-base sm:text-lg text-black leading-relaxed max-w-md mx-auto md:mx-0`}>
                {text}
              </p>
            </div>
