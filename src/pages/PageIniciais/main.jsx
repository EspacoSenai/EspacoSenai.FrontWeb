...
export default function Main() {
  return (
    <main className="bg-white scroll-smooth overflow-hidden relative">
      ...
      {/* Onda superior com movimento suave vertical */}
      <motion.img
      ...
      {/* Onda inferior com movimento suave vertical */}
      <motion.div
        className="relative -z-2 min-1031:mt-[-700px] max-1030:mt-0 min-1031:block max-1030:hidden"
        animate={{ y: [0, 10, 0] }}
        transition={{
          duration: 6,
          ease: "easeInOut",
