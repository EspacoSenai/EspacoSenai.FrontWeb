    ...
    <>
      ...
      <main className="bg-white dark:bg-[#0B0B0B] min-h-screen overflow-hidden relative">
          ...
          <div className="bg-[#B10000] text-white">
            <div className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 py-6 sm:py-7 text-center">
              ...
              <p className="mt-3 text-[12px] sm:text-[13px] md:text-[14px] leading-relaxed opacity-95">
                Descubra uma curadoria de locais únicos e versáteis, prontos
                para receber seu próximo encontro.
              </p>
        ...
        <section className="max-w-6xl mx-auto px-5 sm:px-6 md:px-8 pt-6">
          ...
          {showJoin && (
            <div className="mt-4 rounded-2xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#141414] p-5 sm:p-6">
              ...
              >
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full h-[44px] px-3 rounded-md border border-black/10 dark:border-white/10 bg-white dark:bg-[#111111] text-[#1E1E1E] dark:text-white outline-none focus:ring-2 focus:ring-black/10 dark:focus:ring-white/10"
                  />
                </div>
