// src/pages/Autenticação/EsqueciSenha.jsx
...
export function EsqueciSenha({ buttonWidth = 180, buttonHeight = 36 } = {}) {
  ...
  return (
    <div
      className="min-h-screen w-full flex items-center justify-center relative bg-white overflow-hidden px-4"
      style={{ fontFamily: "Poppins, sans-serif" }}
    >
      <div className="pointer-events-none select-none absolute top-0 right-0 h-full w-[60%] sm:w-[45%] md:w-1/3 z-0 overflow-hidden">
        <img
          src={ondaLateralImg}
      ...
      <div className="pointer-events-none select-none absolute left-0 bottom-0 w-[65%] sm:w-[50%] max-w-[520px] z-0">
        <img
          src={ondaMenorImg}
          alt="Onda decorativa inferior"
          className="h-full w-full object-cover object-left"
        />
      </div>
      ...
      <div className="w-full max-w-sm sm:max-w-md px-2 sm:px-4 py-4 sm:py-8 z-10 flex flex-col items-center justify-center">
        <div
          style={{
            background: "#fff",
            borderRadius: 16,
