...
function TurmaCard({
  ...
  return (
    <div className="w-full max-w-[520px] mx-auto">
      {/* header vermelho */}
      <div
        className="rounded-t-lg px-6 py-3 text-white text-center"
      ...
      <div className="border-x border-b rounded-b-lg border-neutral-200 overflow-hidden bg-white">
        {/* cabeçalho */}
        <div className="grid grid-cols-3 text-center text-[14px] font-semibold bg-white">
        ...
        {/* linha de dados */}
        <div className="grid grid-cols-3 text-[13px] bg-white">
          {/* duração */}
          <div className="border-t border-r border-neutral-200 p-3 text-left">
            <p>Início:</p>
            <span className="inline-block mt-1 px-3 py-1 rounded-sm bg-neutral-100 border border-neutral-200">
              {dataInicio || "—"}
            </span>
          ...
          <div className="border-t border-r border-neutral-200 p-3 flex items-center justify-center">
            <span className="inline-block px-4 py-1 rounded-sm bg-neutral-100 border border-neutral-200 text-center">
              {curso || "—"}
            </span>
          </div>
          ...
          <div className="border-t border-neutral-200 p-3 flex items-center justify-center">
            <span className="inline-block px-4 py-1 rounded-sm bg-neutral-100 border border-neutral-200">
              {modalidade || "—"}
            </span>
          </div>
        </div>
        ...
        {/* footer capacidade */}
        <div className="text-center text-[14px] bg-neutral-100 px-4 py-3">
          {capacidade
