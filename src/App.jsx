...
import GestaoDeAluno from './pages/ADM/gestaoaluno.jsx';
import EditarAluno from './pages/ADM/editargestaodealuno.jsx';
...
export default function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/gestao-alunos" element={<GestaoDeAluno />} />
      <Route path="/gestao-alunos/editar" element={<EditarAluno />} />
