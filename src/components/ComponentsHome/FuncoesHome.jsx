...
export const itemsStaff = [
  ...
  },
  {
    ...
    img: ImgAuditorio,
    desc:
      "Espaço amplo e moderno para apresentações, palestras e eventos especiais.",
    link: "/salas-alunos",
  },
];
...
export function ArrowBtn({ onClick }) {
  return (
    <button
      ...
      onClick={onClick}
      aria-label="Próximo"
      className="absolute z-40 right-[-4px] md:right-[-2px] top-1/2 -translate-y-1/2 h-10 md:h-11 w-10 md:w-11 grid place-items-center rounded-full bg-transparent border-0 hover:scale-[1.06] active:scale-95 focus:outline-none select-none"
