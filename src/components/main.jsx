...
export default function Main() {
  return (
    <main className="bg-white">
          ...
          <div className="w-full md:w-1/3 text-center md:text-left mb-6 md:mb-0">
            <ol className="list-none pl-6 space-y-4 text-lg text-gray-700">
              <li className="flex items-center space-x-3 relative">
                ...
                <div className="absolute left-1 transform -translate-x-1/2 top-2 w-px h-16 bg-[#C5C5C5] z-[0]"></div>
              </li>
              <li className="flex items-center space-x-3 relative">
                ...
                <div className="absolute left-1 transform -translate-x-1/2 top-4 w-px h-16 bg-[#C5C5C5] z-[0]"></div>
              </li>
      ...
      <section className="px-6 md:px-12 py-16 bg-white relative z-10">
        ...
        <img
        src="src/assets/Group48.svg"
        alt="Onda rodapé"
        className="w-full h-auto object-cover absolute top-[-200px] right-0"
        />
      </section>
    </main>
  );
