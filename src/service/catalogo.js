...
/**
 * Salva novos catálogos para um ambiente
 * @param {number} ambienteId - ID do ambiente
 * @param {Array<Object>} catalogos - Lista de catálogos a serem salvos
 * @returns {Promise<Object>} Resposta da API
 */
export async function salvarCatalogos(ambienteId, catalogos) {
  try {
    const response = await api.post(`/catalogo/salvar/${ambienteId}`, catalogos);
    return response.data;
  } catch (error) {
 ...
 * @param {number} ambienteId - ID do ambiente
 * @param {Array<Object>} catalogos - Lista de catálogos a serem atualizados
 * @returns {Promise<Object>} Resposta da API
 */
export async function atualizarCatalogos(ambienteId, catalogos) {
  try {
    const response = await api.patch(`/catalogo/atualizar/${ambienteId}`, catalogos);
    return response.data;
  } catch (error) {
